/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./env.d.ts` (hash: a42497901a2b2b6932187d30c89956d5)
// Runtime types generated with workerd@1.20250902.0 2025-08-27 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		AWS_REDIRECT_API_KEY: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		BASE_URL: string;
		BASE_URL_2: string;
		AWS_ACCESS_KEY_ID_WRITE: string;
		AWS_SECRET_ACCESS_KEY_WRITE: string;
		ADMIN_API_TOKEN: string;
		R2_ASSETS: R2Bucket;
		D1_POSTS: D1Database;
		ADMIN_API_TOKEN: SecretsStoreSecret;
		AWS_ACCESS_KEY_ID: SecretsStoreSecret;
		AWS_SECRET_ACCESS_KEY: SecretsStoreSecret;
		AWS_REGION: SecretsStoreSecret;
		AWS_BUCKET_NAME: SecretsStoreSecret;
		S3_ENDPOINT: SecretsStoreSecret;
		CDN_SITE: SecretsStoreSecret;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_VERSION" | "NEXTJS_ENV" | "CDN_SITE" | "AWS_REGION" | "AWS_BUCKET_NAME" | "S3_ENDPOINT" | "AWS_ACCESS_KEY_ID" | "AWS_SECRET_ACCESS_KEY" | "AWS_REDIRECT_API_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "BASE_URL" | "BASE_URL_2" | "AWS_ACCESS_KEY_ID_WRITE" | "AWS_SECRET_ACCESS_KEY_WRITE" | "ADMIN_API_TOKEN">> {}
}
